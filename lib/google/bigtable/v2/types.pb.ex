defmodule Google.Bigtable.V2.Type.Bytes.Encoding.Raw do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Bytes.Encoding.Raw",
...
defmodule Google.Bigtable.V2.Type.Bytes.Encoding do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Bytes.Encoding",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.Type.Bytes do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Bytes",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.Type.String.Encoding.Utf8Raw do
  ...
  use Protobuf,
    deprecated: true,
    full_name: "google.bigtable.v2.Type.String.Encoding.Utf8Raw",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
end
...
defmodule Google.Bigtable.V2.Type.String.Encoding.Utf8Bytes do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.String.Encoding.Utf8Bytes",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.Type.String.Encoding do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.String.Encoding",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.Type.String do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.String",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.Type.Int64.Encoding.BigEndianBytes do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Int64.Encoding.BigEndianBytes",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.Type.Int64.Encoding.OrderedCodeBytes do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Int64.Encoding.OrderedCodeBytes",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
end
...
defmodule Google.Bigtable.V2.Type.Int64.Encoding do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Int64.Encoding",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.Type.Int64 do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Int64",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.Type.Bool do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Bool",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
end
...
defmodule Google.Bigtable.V2.Type.Float32 do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Float32",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
end
...
defmodule Google.Bigtable.V2.Type.Float64 do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Float64",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
end
...
defmodule Google.Bigtable.V2.Type.Timestamp.Encoding do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Timestamp.Encoding",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.Type.Timestamp do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Timestamp",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.Type.Date do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Date",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
end
...
defmodule Google.Bigtable.V2.Type.Struct.Field do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Struct.Field",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.Type.Struct.Encoding.Singleton do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Struct.Encoding.Singleton",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
end
...
defmodule Google.Bigtable.V2.Type.Struct.Encoding.DelimitedBytes do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Struct.Encoding.DelimitedBytes",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.Type.Struct.Encoding.OrderedCodeBytes do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Struct.Encoding.OrderedCodeBytes",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
end
...
defmodule Google.Bigtable.V2.Type.Struct.Encoding do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Struct.Encoding",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.Type.Struct do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Struct",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.Type.Proto do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Proto",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.Type.Enum do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Enum",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.Type.Array do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Array",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.Type.Map do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Map",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.Type.Aggregate.Sum do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Aggregate.Sum",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
end
...
defmodule Google.Bigtable.V2.Type.Aggregate.Max do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Aggregate.Max",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
end
...
defmodule Google.Bigtable.V2.Type.Aggregate.Min do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Aggregate.Min",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
end
...
defmodule Google.Bigtable.V2.Type.Aggregate.HyperLogLogPlusPlusUniqueCount do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Aggregate.HyperLogLogPlusPlusUniqueCount",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
end
...
defmodule Google.Bigtable.V2.Type.Aggregate do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type.Aggregate",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.Type do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Type",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
