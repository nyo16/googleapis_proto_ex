defmodule Google.Bigtable.V2.PeerInfo.TransportType do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.bigtable.v2.PeerInfo.TransportType",
...
defmodule Google.Bigtable.V2.PeerInfo do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.PeerInfo",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
  ...
  field :application_frontend_region, 6, type: :string, json_name: "applicationFrontendRegion"

  field :application_frontend_zone, 3,
    type: :string,
    json_name: "applicationFrontendZone",
    deprecated: true
