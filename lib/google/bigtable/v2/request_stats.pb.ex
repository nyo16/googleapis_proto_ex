defmodule Google.Bigtable.V2.ReadIterationStats do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.ReadIterationStats",
...
defmodule Google.Bigtable.V2.RequestLatencyStats do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.RequestLatencyStats",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.FullReadStatsView do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.FullReadStatsView",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.RequestStats do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.RequestStats",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
