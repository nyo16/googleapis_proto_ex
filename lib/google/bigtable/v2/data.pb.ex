...
defmodule Google.Bigtable.V2.Value do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Value",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.ArrayValue do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.ArrayValue",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.ValueBitmask do
  @moduledoc false

  use Protobuf,
    full_name: "google.bigtable.v2.ValueBitmask",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3

  field :mask, 1, type: :bytes, deprecated: false
end
...
defmodule Google.Bigtable.V2.RowFilter do
  ...
  field :value_bitmask_filter, 20,
    type: Google.Bigtable.V2.ValueBitmask,
    json_name: "valueBitmaskFilter",
    oneof: 0
end
...
defmodule Google.Bigtable.V2.Mutation.AddToCell do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Mutation.AddToCell",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.Mutation.MergeToCell do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Mutation.MergeToCell",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.StreamPartition do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.StreamPartition",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.StreamContinuationTokens do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.StreamContinuationTokens",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.StreamContinuationToken do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.StreamContinuationToken",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.ProtoFormat do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.ProtoFormat",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
end
...
defmodule Google.Bigtable.V2.ColumnMetadata do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.ColumnMetadata",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.ProtoSchema do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.ProtoSchema",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.ResultSetMetadata do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.ResultSetMetadata",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.ProtoRows do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.ProtoRows",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.ProtoRowsBatch do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.ProtoRowsBatch",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.PartialResultSet do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.PartialResultSet",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.Idempotency do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.Idempotency",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
