defmodule Google.Bigtable.V2.ReadRowsRequest.RequestStatsView do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.bigtable.v2.ReadRowsRequest.RequestStatsView",
...
defmodule Google.Bigtable.V2.ReadChangeStreamResponse.DataChange.Type do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.bigtable.v2.ReadChangeStreamResponse.DataChange.Type",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.SampleRowKeysRequest do
  ...
  field :row_range, 6, type: Google.Bigtable.V2.RowRange, json_name: "rowRange", deprecated: false
end
...
defmodule Google.Bigtable.V2.RateLimitInfo do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.RateLimitInfo",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.PingAndWarmRequest do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.PingAndWarmRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.PingAndWarmResponse do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.PingAndWarmResponse",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
end
...
defmodule Google.Bigtable.V2.GenerateInitialChangeStreamPartitionsRequest do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.GenerateInitialChangeStreamPartitionsRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.GenerateInitialChangeStreamPartitionsResponse do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.GenerateInitialChangeStreamPartitionsResponse",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.ReadChangeStreamRequest do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.ReadChangeStreamRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.ReadChangeStreamResponse.MutationChunk.ChunkInfo do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.ReadChangeStreamResponse.MutationChunk.ChunkInfo",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.ReadChangeStreamResponse.MutationChunk do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.ReadChangeStreamResponse.MutationChunk",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.ReadChangeStreamResponse.DataChange do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.ReadChangeStreamResponse.DataChange",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.ReadChangeStreamResponse.Heartbeat do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.ReadChangeStreamResponse.Heartbeat",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.ReadChangeStreamResponse.CloseStream do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.ReadChangeStreamResponse.CloseStream",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.ReadChangeStreamResponse do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.ReadChangeStreamResponse",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.ExecuteQueryRequest.ParamsEntry do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.ExecuteQueryRequest.ParamsEntry",
    map: true,
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.ExecuteQueryRequest.ViewParametersEntry do
  @moduledoc false

  use Protobuf,
    full_name: "google.bigtable.v2.ExecuteQueryRequest.ViewParametersEntry",
    map: true,
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.ExecuteQueryRequest do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.ExecuteQueryRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
  ...
  field :view_parameters, 12,
    repeated: true,
    type: Google.Bigtable.V2.ExecuteQueryRequest.ViewParametersEntry,
    json_name: "viewParameters",
    map: true,
    deprecated: false
end
...
defmodule Google.Bigtable.V2.ExecuteQueryResponse do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.ExecuteQueryResponse",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.PrepareQueryRequest.ParamTypesEntry do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.PrepareQueryRequest.ParamTypesEntry",
    map: true,
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.PrepareQueryRequest do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.PrepareQueryRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.PrepareQueryResponse do
  ...
  use Protobuf,
    full_name: "google.bigtable.v2.PrepareQueryResponse",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.V2.Bigtable.Service do
  ...
  use GRPC.Service, name: "google.bigtable.v2.Bigtable", protoc_gen_elixir_version: "0.17.0"
  ...
  rpc :GetClientConfiguration,
      Google.Bigtable.V2.GetClientConfigurationRequest,
      Google.Bigtable.V2.ClientConfiguration

  rpc :OpenTable,
      stream(Google.Bigtable.V2.SessionRequest),
      stream(Google.Bigtable.V2.SessionResponse)

  rpc :OpenAuthorizedView,
      stream(Google.Bigtable.V2.SessionRequest),
      stream(Google.Bigtable.V2.SessionResponse)

  rpc :OpenMaterializedView,
      stream(Google.Bigtable.V2.SessionRequest),
      stream(Google.Bigtable.V2.SessionResponse)
end
