...
defmodule Google.Bigtable.Admin.V2.Instance.Edition do
  @moduledoc false

  use Protobuf,
    enum: true,
    full_name: "google.bigtable.admin.v2.Instance.Edition",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.Admin.V2.Cluster.NodeScalingFactor do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.bigtable.admin.v2.Cluster.NodeScalingFactor",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.Admin.V2.AppProfile.Priority do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.bigtable.admin.v2.AppProfile.Priority",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.Admin.V2.Instance.TagsEntry do
  ...
  use Protobuf,
    full_name: "google.bigtable.admin.v2.Instance.TagsEntry",
    map: true,
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.Admin.V2.Instance do
  ...
  field :edition, 14,
    type: Google.Bigtable.Admin.V2.Instance.Edition,
    enum: true,
    deprecated: false
...
defmodule Google.Bigtable.Admin.V2.AppProfile.MultiClusterRoutingUseAny.RowAffinity do
  ...
  use Protobuf,
    full_name: "google.bigtable.admin.v2.AppProfile.MultiClusterRoutingUseAny.RowAffinity",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
end
...
defmodule Google.Bigtable.Admin.V2.AppProfile.StandardIsolation do
  ...
  use Protobuf,
    full_name: "google.bigtable.admin.v2.AppProfile.StandardIsolation",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.Admin.V2.AppProfile.DataBoostIsolationReadOnly do
  ...
  use Protobuf,
    full_name: "google.bigtable.admin.v2.AppProfile.DataBoostIsolationReadOnly",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.Admin.V2.HotTablet do
  ...
  use Protobuf,
    full_name: "google.bigtable.admin.v2.HotTablet",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.Admin.V2.LogicalView do
  ...
  use Protobuf,
    full_name: "google.bigtable.admin.v2.LogicalView",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.Admin.V2.MaterializedView do
  ...
  use Protobuf,
    full_name: "google.bigtable.admin.v2.MaterializedView",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
