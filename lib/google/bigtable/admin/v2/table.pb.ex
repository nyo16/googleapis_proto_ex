...
defmodule Google.Bigtable.Admin.V2.AuthorizedView.ResponseView do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.bigtable.admin.v2.AuthorizedView.ResponseView",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.Admin.V2.EncryptionInfo.EncryptionType do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.bigtable.admin.v2.EncryptionInfo.EncryptionType",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.Admin.V2.Backup.BackupType do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.bigtable.admin.v2.Backup.BackupType",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.Admin.V2.ChangeStreamConfig do
  ...
  use Protobuf,
    full_name: "google.bigtable.admin.v2.ChangeStreamConfig",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.Admin.V2.Table.AutomatedBackupPolicy do
  ...
  use Protobuf,
    full_name: "google.bigtable.admin.v2.Table.AutomatedBackupPolicy",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
  ...
  field :frequency, 2, type: Google.Protobuf.Duration
  field :locations, 3, repeated: true, type: :string, deprecated: false
end
...
defmodule Google.Bigtable.Admin.V2.Table do
  ...
  field :tiered_storage_config, 14,
    type: Google.Bigtable.Admin.V2.TieredStorageConfig,
    json_name: "tieredStorageConfig"
...
defmodule Google.Bigtable.Admin.V2.AuthorizedView.FamilySubsets do
  ...
  use Protobuf,
    full_name: "google.bigtable.admin.v2.AuthorizedView.FamilySubsets",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.Admin.V2.AuthorizedView.SubsetView.FamilySubsetsEntry do
  ...
  use Protobuf,
    full_name: "google.bigtable.admin.v2.AuthorizedView.SubsetView.FamilySubsetsEntry",
    map: true,
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.Admin.V2.AuthorizedView.SubsetView do
  ...
  use Protobuf,
    full_name: "google.bigtable.admin.v2.AuthorizedView.SubsetView",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.Admin.V2.AuthorizedView do
  ...
  use Protobuf,
    full_name: "google.bigtable.admin.v2.AuthorizedView",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.Admin.V2.EncryptionInfo do
  ...
  use Protobuf,
    full_name: "google.bigtable.admin.v2.EncryptionInfo",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.Admin.V2.TieredStorageConfig do
  @moduledoc false

  use Protobuf,
    full_name: "google.bigtable.admin.v2.TieredStorageConfig",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3

  field :infrequent_access, 1,
    type: Google.Bigtable.Admin.V2.TieredStorageRule,
    json_name: "infrequentAccess"
end

defmodule Google.Bigtable.Admin.V2.TieredStorageRule do
  @moduledoc false

  use Protobuf,
    full_name: "google.bigtable.admin.v2.TieredStorageRule",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3

  oneof :rule, 0

  field :include_if_older_than, 1,
    type: Google.Protobuf.Duration,
    json_name: "includeIfOlderThan",
    oneof: 0
end
...
defmodule Google.Bigtable.Admin.V2.ProtoSchema do
  ...
  use Protobuf,
    full_name: "google.bigtable.admin.v2.ProtoSchema",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Bigtable.Admin.V2.SchemaBundle do
  ...
  use Protobuf,
    full_name: "google.bigtable.admin.v2.SchemaBundle",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
