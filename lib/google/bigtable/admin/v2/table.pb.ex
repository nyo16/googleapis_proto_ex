...
defmodule Google.Bigtable.Admin.V2.Table.View do
  ...
  @type t :: integer | :VIEW_UNSPECIFIED | :NAME_ONLY | :SCHEMA_VIEW | :REPLICATION_VIEW | :FULL
...
defmodule Google.Bigtable.Admin.V2.Backup do
  ...
  defstruct [:name, :source_table, :expire_time, :start_time, :end_time, :size_bytes, :state]
