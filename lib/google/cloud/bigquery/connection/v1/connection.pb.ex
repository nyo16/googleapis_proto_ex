...
defmodule Google.Cloud.Bigquery.Connection.V1.AzureProperties do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.connection.v1.AzureProperties",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.Connection.V1.CloudResourceProperties do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.connection.v1.CloudResourceProperties",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.Connection.V1.MetastoreServiceConfig do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.connection.v1.MetastoreServiceConfig",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.Connection.V1.SparkHistoryServerConfig do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.connection.v1.SparkHistoryServerConfig",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.Connection.V1.SparkProperties do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.connection.v1.SparkProperties",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.Connection.V1.SalesforceDataCloudProperties do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.connection.v1.SalesforceDataCloudProperties",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
