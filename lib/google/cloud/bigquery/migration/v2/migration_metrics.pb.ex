defmodule Google.Cloud.Bigquery.Migration.V2.TimeSeries do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.migration.v2.TimeSeries",
...
defmodule Google.Cloud.Bigquery.Migration.V2.Point do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.migration.v2.Point",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.Migration.V2.TimeInterval do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.migration.v2.TimeInterval",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.Migration.V2.TypedValue do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.migration.v2.TypedValue",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
