defmodule Google.Cloud.Bigquery.Migration.V2.ResourceErrorDetail do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.migration.v2.ResourceErrorDetail",
...
defmodule Google.Cloud.Bigquery.Migration.V2.ErrorDetail do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.migration.v2.ErrorDetail",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.Migration.V2.ErrorLocation do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.migration.v2.ErrorLocation",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
