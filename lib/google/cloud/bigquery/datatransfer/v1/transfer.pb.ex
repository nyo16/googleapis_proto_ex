...
defmodule Google.Cloud.Bigquery.Datatransfer.V1.ScheduleOptionsV2 do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.datatransfer.v1.ScheduleOptionsV2",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.Datatransfer.V1.TimeBasedSchedule do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.datatransfer.v1.TimeBasedSchedule",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.Datatransfer.V1.ManualSchedule do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.datatransfer.v1.ManualSchedule",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
end
...
defmodule Google.Cloud.Bigquery.Datatransfer.V1.EventDrivenSchedule do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.datatransfer.v1.EventDrivenSchedule",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.Datatransfer.V1.UserInfo do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.datatransfer.v1.UserInfo",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.Datatransfer.V1.EncryptionConfiguration do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.datatransfer.v1.EncryptionConfiguration",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
