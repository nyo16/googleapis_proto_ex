defmodule Google.Cloud.Bigquery.Storage.V1.TableFieldSchema.Type do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.cloud.bigquery.storage.v1.TableFieldSchema.Type",
...
defmodule Google.Cloud.Bigquery.Storage.V1.TableFieldSchema.Mode do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.cloud.bigquery.storage.v1.TableFieldSchema.Mode",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.Storage.V1.TableSchema do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.storage.v1.TableSchema",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.Storage.V1.TableFieldSchema.FieldElementType do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.storage.v1.TableFieldSchema.FieldElementType",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.Storage.V1.TableFieldSchema do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.storage.v1.TableFieldSchema",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
