defmodule Google.Cloud.Bigquery.V2.ExternalCatalogTableOptions.ParametersEntry do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.ExternalCatalogTableOptions.ParametersEntry",
    map: true,
...
defmodule Google.Cloud.Bigquery.V2.ExternalCatalogTableOptions do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.ExternalCatalogTableOptions",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.StorageDescriptor do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.StorageDescriptor",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.SerDeInfo.ParametersEntry do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.SerDeInfo.ParametersEntry",
    map: true,
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.SerDeInfo do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.SerDeInfo",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
