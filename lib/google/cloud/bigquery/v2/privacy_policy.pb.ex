defmodule Google.Cloud.Bigquery.V2.JoinRestrictionPolicy.JoinCondition do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.cloud.bigquery.v2.JoinRestrictionPolicy.JoinCondition",
...
defmodule Google.Cloud.Bigquery.V2.AggregationThresholdPolicy do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.AggregationThresholdPolicy",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.DifferentialPrivacyPolicy do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.DifferentialPrivacyPolicy",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.JoinRestrictionPolicy do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.JoinRestrictionPolicy",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.PrivacyPolicy do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.PrivacyPolicy",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
