defmodule Google.Cloud.Bigquery.V2.ReservationEdition do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.cloud.bigquery.v2.ReservationEdition",
...
defmodule Google.Cloud.Bigquery.V2.ExplainQueryStage.ComputeMode do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.cloud.bigquery.v2.ExplainQueryStage.ComputeMode",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.BiEngineReason.Code do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.cloud.bigquery.v2.BiEngineReason.Code",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.BiEngineStatistics.BiEngineMode do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.cloud.bigquery.v2.BiEngineStatistics.BiEngineMode",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.BiEngineStatistics.BiEngineAccelerationMode do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.cloud.bigquery.v2.BiEngineStatistics.BiEngineAccelerationMode",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.IndexUnusedReason.Code do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.cloud.bigquery.v2.IndexUnusedReason.Code",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.StoredColumnsUsage.StoredColumnsUnusedReason.Code do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.cloud.bigquery.v2.StoredColumnsUsage.StoredColumnsUnusedReason.Code",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.SearchStatistics.IndexUsageMode do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.cloud.bigquery.v2.SearchStatistics.IndexUsageMode",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.VectorSearchStatistics.IndexUsageMode do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.cloud.bigquery.v2.VectorSearchStatistics.IndexUsageMode",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.IncrementalResultStats.DisabledReason do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.cloud.bigquery.v2.IncrementalResultStats.DisabledReason",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3

  field :DISABLED_REASON_UNSPECIFIED, 0
  field :OTHER, 1
  field :UNSUPPORTED_OPERATOR, 2
end
...
defmodule Google.Cloud.Bigquery.V2.MlStatistics.TrainingType do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.cloud.bigquery.v2.MlStatistics.TrainingType",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.ScriptStatistics.EvaluationKind do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.cloud.bigquery.v2.ScriptStatistics.EvaluationKind",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.DmlStats.DmlMode do
  @moduledoc false

  use Protobuf,
    enum: true,
    full_name: "google.cloud.bigquery.v2.DmlStats.DmlMode",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3

  field :DML_MODE_UNSPECIFIED, 0
  field :COARSE_GRAINED_DML, 1
  field :FINE_GRAINED_DML, 2
end

defmodule Google.Cloud.Bigquery.V2.DmlStats.FineGrainedDmlUnusedReason do
  @moduledoc false

  use Protobuf,
    enum: true,
    full_name: "google.cloud.bigquery.v2.DmlStats.FineGrainedDmlUnusedReason",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3

  field :FINE_GRAINED_DML_UNUSED_REASON_UNSPECIFIED, 0
  field :MAX_PARTITION_SIZE_EXCEEDED, 1
  field :TABLE_NOT_ENROLLED, 2
  field :DML_IN_MULTI_STATEMENT_TRANSACTION, 3
end
...
defmodule Google.Cloud.Bigquery.V2.MaterializedView.RejectedReason do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.cloud.bigquery.v2.MaterializedView.RejectedReason",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.TableMetadataCacheUsage.UnusedReason do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.cloud.bigquery.v2.TableMetadataCacheUsage.UnusedReason",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.ExplainQueryStep do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.ExplainQueryStep",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.ExplainQueryStage do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.ExplainQueryStage",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.QueryTimelineSample do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.QueryTimelineSample",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.ExternalServiceCost do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.ExternalServiceCost",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.ExportDataStatistics do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.ExportDataStatistics",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.BiEngineReason do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.BiEngineReason",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.BiEngineStatistics do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.BiEngineStatistics",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.IndexUnusedReason do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.IndexUnusedReason",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.IndexPruningStats do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.IndexPruningStats",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.StoredColumnsUsage.StoredColumnsUnusedReason do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.StoredColumnsUsage.StoredColumnsUnusedReason",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.StoredColumnsUsage do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.StoredColumnsUsage",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.SearchStatistics do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.SearchStatistics",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.VectorSearchStatistics do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.VectorSearchStatistics",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.QueryInfo do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.QueryInfo",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.LoadQueryStatistics do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.LoadQueryStatistics",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.IncrementalResultStats do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.IncrementalResultStats",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
  ...
  field :disabled_reason_details, 4,
    type: :string,
    json_name: "disabledReasonDetails",
    deprecated: false
  ...
  field :first_incremental_row_time, 5,
    type: Google.Protobuf.Timestamp,
    json_name: "firstIncrementalRowTime",
    deprecated: false

  field :last_incremental_row_time, 6,
    type: Google.Protobuf.Timestamp,
    json_name: "lastIncrementalRowTime",
    deprecated: false

  field :incremental_row_count, 7,
    proto3_optional: true,
    type: :int64,
    json_name: "incrementalRowCount",
    deprecated: false
end
...
defmodule Google.Cloud.Bigquery.V2.JobStatistics2 do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.JobStatistics2",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
  ...
  field :referenced_property_graphs, 49,
    repeated: true,
    type: Google.Cloud.Bigquery.V2.PropertyGraphReference,
    json_name: "referencedPropertyGraphs",
    deprecated: false
  ...
  field :gen_ai_stats, 54,
    type: Google.Cloud.Bigquery.V2.GenAiStats,
    json_name: "genAiStats",
    deprecated: false
end
...
defmodule Google.Cloud.Bigquery.V2.JobStatistics3 do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.JobStatistics3",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.JobStatistics4 do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.JobStatistics4",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.CopyJobStatistics do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.CopyJobStatistics",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.MlStatistics do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.MlStatistics",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.ScriptStatistics.ScriptStackFrame do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.ScriptStatistics.ScriptStackFrame",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.ScriptStatistics do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.ScriptStatistics",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.RowLevelSecurityStatistics do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.RowLevelSecurityStatistics",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.DataMaskingStatistics do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.DataMaskingStatistics",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.JobStatistics.TransactionInfo do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.JobStatistics.TransactionInfo",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.JobStatistics do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.JobStatistics",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.DmlStats do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.DmlStats",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
  ...
  field :dml_mode, 4,
    type: Google.Cloud.Bigquery.V2.DmlStats.DmlMode,
    json_name: "dmlMode",
    enum: true,
    deprecated: false

  field :fine_grained_dml_unused_reason, 5,
    type: Google.Cloud.Bigquery.V2.DmlStats.FineGrainedDmlUnusedReason,
    json_name: "fineGrainedDmlUnusedReason",
    enum: true,
    deprecated: false
end
...
defmodule Google.Cloud.Bigquery.V2.PerformanceInsights do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.PerformanceInsights",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
  ...
  field :table_change_insights, 4,
    repeated: true,
    type: Google.Cloud.Bigquery.V2.TableChangeInsight,
    json_name: "tableChangeInsights",
    deprecated: false
end
...
defmodule Google.Cloud.Bigquery.V2.StagePerformanceChangeInsight do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.StagePerformanceChangeInsight",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.InputDataChange do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.InputDataChange",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.StagePerformanceStandaloneInsight do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.StagePerformanceStandaloneInsight",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.HighCardinalityJoin do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.HighCardinalityJoin",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.PartitionSkew.SkewSource do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.PartitionSkew.SkewSource",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.PartitionSkew do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.PartitionSkew",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.TableChangeInsight do
  @moduledoc false

  use Protobuf,
    full_name: "google.cloud.bigquery.v2.TableChangeInsight",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
  ...
  field :metadata_cache_staleness_insight, 2,
    proto3_optional: true,
    type: Google.Cloud.Bigquery.V2.MetadataCacheStalenessInsight,
    json_name: "metadataCacheStalenessInsight",
    deprecated: false

  field :metadata_cache_not_used_but_used_previously, 3,
    proto3_optional: true,
    type: :bool,
    json_name: "metadataCacheNotUsedButUsedPreviously",
    deprecated: false
end

defmodule Google.Cloud.Bigquery.V2.MetadataCacheStalenessInsight do
  @moduledoc false

  use Protobuf,
    full_name: "google.cloud.bigquery.v2.MetadataCacheStalenessInsight",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3

  field :avg_previous_staleness_ms, 1,
    type: Google.Protobuf.Duration,
    json_name: "avgPreviousStalenessMs",
    deprecated: false

  field :staleness_percentage_increase, 2,
    type: :double,
    json_name: "stalenessPercentageIncrease",
    deprecated: false
end
...
defmodule Google.Cloud.Bigquery.V2.SparkStatistics.LoggingInfo do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.SparkStatistics.LoggingInfo",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.SparkStatistics.EndpointsEntry do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.SparkStatistics.EndpointsEntry",
    map: true,
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.SparkStatistics do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.SparkStatistics",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.MaterializedViewStatistics do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.MaterializedViewStatistics",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.MaterializedView do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.MaterializedView",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.PruningStats do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.PruningStats",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.TableMetadataCacheUsage do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.TableMetadataCacheUsage",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.MetadataCacheStatistics do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.MetadataCacheStatistics",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
