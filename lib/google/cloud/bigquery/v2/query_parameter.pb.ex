defmodule Google.Cloud.Bigquery.V2.QueryParameterStructType do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.QueryParameterStructType",
...
defmodule Google.Cloud.Bigquery.V2.QueryParameterType do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.QueryParameterType",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.RangeValue do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.RangeValue",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.QueryParameterValue.StructValuesEntry do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.QueryParameterValue.StructValuesEntry",
    map: true,
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.QueryParameterValue do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.QueryParameterValue",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Bigquery.V2.QueryParameter do
  ...
  use Protobuf,
    full_name: "google.cloud.bigquery.v2.QueryParameter",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
