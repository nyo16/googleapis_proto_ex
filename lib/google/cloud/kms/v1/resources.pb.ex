...
defmodule Google.Cloud.Kms.V1.AccessReason do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.cloud.kms.v1.AccessReason",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Kms.V1.CryptoKeyVersion.CryptoKeyVersionAlgorithm do
  ...
  field :KEM_XWING, 63
  field :PQ_SIGN_ML_DSA_44, 68
  field :PQ_SIGN_ML_DSA_65, 56
  field :PQ_SIGN_ML_DSA_87, 69
  field :PQ_SIGN_SLH_DSA_SHA2_128S, 57
  field :PQ_SIGN_HASH_SLH_DSA_SHA2_128S_SHA256, 60
  field :PQ_SIGN_ML_DSA_44_EXTERNAL_MU, 70
  field :PQ_SIGN_ML_DSA_65_EXTERNAL_MU, 67
  field :PQ_SIGN_ML_DSA_87_EXTERNAL_MU, 71
end
...
defmodule Google.Cloud.Kms.V1.PublicKey.PublicKeyFormat do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.cloud.kms.v1.PublicKey.PublicKeyFormat",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Kms.V1.KeyOperationAttestation.CertificateChains do
  ...
  use Protobuf,
    full_name: "google.cloud.kms.v1.KeyOperationAttestation.CertificateChains",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Kms.V1.ChecksummedData do
  ...
  use Protobuf,
    full_name: "google.cloud.kms.v1.ChecksummedData",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Kms.V1.ImportJob do
  ...
  field :attestation, 8, type: Google.Cloud.Kms.V1.KeyOperationAttestation, deprecated: false
  field :crypto_key_backend, 11, type: :string, json_name: "cryptoKeyBackend", deprecated: false
end
...
defmodule Google.Cloud.Kms.V1.KeyAccessJustificationsPolicy do
  ...
  use Protobuf,
    full_name: "google.cloud.kms.v1.KeyAccessJustificationsPolicy",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Kms.V1.RetiredResource do
  @moduledoc false

  use Protobuf,
    full_name: "google.cloud.kms.v1.RetiredResource",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3

  field :name, 1, type: :string, deprecated: false
  field :original_resource, 2, type: :string, json_name: "originalResource", deprecated: false
  field :resource_type, 3, type: :string, json_name: "resourceType", deprecated: false
