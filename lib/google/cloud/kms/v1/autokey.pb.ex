defmodule Google.Cloud.Kms.V1.CreateKeyHandleRequest do
  ...
  use Protobuf,
    full_name: "google.cloud.kms.v1.CreateKeyHandleRequest",
...
defmodule Google.Cloud.Kms.V1.GetKeyHandleRequest do
  ...
  use Protobuf,
    full_name: "google.cloud.kms.v1.GetKeyHandleRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Kms.V1.KeyHandle do
  ...
  use Protobuf,
    full_name: "google.cloud.kms.v1.KeyHandle",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Kms.V1.CreateKeyHandleMetadata do
  ...
  use Protobuf,
    full_name: "google.cloud.kms.v1.CreateKeyHandleMetadata",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
end
...
defmodule Google.Cloud.Kms.V1.ListKeyHandlesRequest do
  ...
  use Protobuf,
    full_name: "google.cloud.kms.v1.ListKeyHandlesRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Kms.V1.ListKeyHandlesResponse do
  ...
  use Protobuf,
    full_name: "google.cloud.kms.v1.ListKeyHandlesResponse",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Kms.V1.Autokey.Service do
  ...
  use GRPC.Service, name: "google.cloud.kms.v1.Autokey", protoc_gen_elixir_version: "0.17.0"
