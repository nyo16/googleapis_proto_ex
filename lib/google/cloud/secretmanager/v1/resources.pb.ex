...
defmodule Google.Cloud.Secretmanager.V1.Secret.VersionAliasesEntry do
  ...
  use Protobuf,
    full_name: "google.cloud.secretmanager.v1.Secret.VersionAliasesEntry",
    map: true,
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Secretmanager.V1.Secret.AnnotationsEntry do
  ...
  use Protobuf,
    full_name: "google.cloud.secretmanager.v1.Secret.AnnotationsEntry",
    map: true,
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Cloud.Secretmanager.V1.Secret.TagsEntry do
  ...
  use Protobuf,
    full_name: "google.cloud.secretmanager.v1.Secret.TagsEntry",
    map: true,
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
