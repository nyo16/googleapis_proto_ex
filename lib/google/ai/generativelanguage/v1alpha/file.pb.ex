defmodule Google.Ai.Generativelanguage.V1alpha.File.State do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.ai.generativelanguage.v1alpha.File.State",
...
defmodule Google.Ai.Generativelanguage.V1alpha.File do
  ...
  use Protobuf,
    full_name: "google.ai.generativelanguage.v1alpha.File",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Ai.Generativelanguage.V1alpha.VideoMetadata do
  ...
  use Protobuf,
    full_name: "google.ai.generativelanguage.v1alpha.VideoMetadata",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
