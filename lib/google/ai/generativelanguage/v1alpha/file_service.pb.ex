defmodule Google.Ai.Generativelanguage.V1alpha.CreateFileRequest do
  ...
  use Protobuf,
    full_name: "google.ai.generativelanguage.v1alpha.CreateFileRequest",
...
defmodule Google.Ai.Generativelanguage.V1alpha.CreateFileResponse do
  ...
  use Protobuf,
    full_name: "google.ai.generativelanguage.v1alpha.CreateFileResponse",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Ai.Generativelanguage.V1alpha.ListFilesRequest do
  ...
  use Protobuf,
    full_name: "google.ai.generativelanguage.v1alpha.ListFilesRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Ai.Generativelanguage.V1alpha.ListFilesResponse do
  ...
  use Protobuf,
    full_name: "google.ai.generativelanguage.v1alpha.ListFilesResponse",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Ai.Generativelanguage.V1alpha.GetFileRequest do
  ...
  use Protobuf,
    full_name: "google.ai.generativelanguage.v1alpha.GetFileRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Ai.Generativelanguage.V1alpha.DeleteFileRequest do
  ...
  use Protobuf,
    full_name: "google.ai.generativelanguage.v1alpha.DeleteFileRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
