defmodule Google.Ai.Generativelanguage.V1alpha.ListCachedContentsRequest do
  ...
  use Protobuf,
    full_name: "google.ai.generativelanguage.v1alpha.ListCachedContentsRequest",
...
defmodule Google.Ai.Generativelanguage.V1alpha.ListCachedContentsResponse do
  ...
  use Protobuf,
    full_name: "google.ai.generativelanguage.v1alpha.ListCachedContentsResponse",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Ai.Generativelanguage.V1alpha.CreateCachedContentRequest do
  ...
  use Protobuf,
    full_name: "google.ai.generativelanguage.v1alpha.CreateCachedContentRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Ai.Generativelanguage.V1alpha.GetCachedContentRequest do
  ...
  use Protobuf,
    full_name: "google.ai.generativelanguage.v1alpha.GetCachedContentRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Ai.Generativelanguage.V1alpha.UpdateCachedContentRequest do
  ...
  use Protobuf,
    full_name: "google.ai.generativelanguage.v1alpha.UpdateCachedContentRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Ai.Generativelanguage.V1alpha.DeleteCachedContentRequest do
  ...
  use Protobuf,
    full_name: "google.ai.generativelanguage.v1alpha.DeleteCachedContentRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
