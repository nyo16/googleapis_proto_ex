defmodule Google.Ai.Generativelanguage.V1beta.File.State do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.ai.generativelanguage.v1beta.File.State",
...
defmodule Google.Ai.Generativelanguage.V1beta.File.Source do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.ai.generativelanguage.v1beta.File.Source",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Ai.Generativelanguage.V1beta.File do
  ...
  use Protobuf,
    full_name: "google.ai.generativelanguage.v1beta.File",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Ai.Generativelanguage.V1beta.VideoFileMetadata do
  ...
  use Protobuf,
    full_name: "google.ai.generativelanguage.v1beta.VideoFileMetadata",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
