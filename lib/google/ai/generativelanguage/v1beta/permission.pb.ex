defmodule Google.Ai.Generativelanguage.V1beta.Permission.GranteeType do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.ai.generativelanguage.v1beta.Permission.GranteeType",
...
defmodule Google.Ai.Generativelanguage.V1beta.Permission.Role do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.ai.generativelanguage.v1beta.Permission.Role",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Ai.Generativelanguage.V1beta.Permission do
  ...
  use Protobuf,
    full_name: "google.ai.generativelanguage.v1beta.Permission",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
