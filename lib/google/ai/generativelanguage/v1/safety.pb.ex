defmodule Google.Ai.Generativelanguage.V1.HarmCategory do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.ai.generativelanguage.v1.HarmCategory",
...
defmodule Google.Ai.Generativelanguage.V1.SafetyRating.HarmProbability do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.ai.generativelanguage.v1.SafetyRating.HarmProbability",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Ai.Generativelanguage.V1.SafetySetting.HarmBlockThreshold do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.ai.generativelanguage.v1.SafetySetting.HarmBlockThreshold",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Ai.Generativelanguage.V1.SafetyRating do
  ...
  use Protobuf,
    full_name: "google.ai.generativelanguage.v1.SafetyRating",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Ai.Generativelanguage.V1.SafetySetting do
  ...
  use Protobuf,
    full_name: "google.ai.generativelanguage.v1.SafetySetting",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
