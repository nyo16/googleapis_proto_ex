defmodule Google.Ai.Generativelanguage.V1.GetModelRequest do
  ...
  use Protobuf,
    full_name: "google.ai.generativelanguage.v1.GetModelRequest",
...
defmodule Google.Ai.Generativelanguage.V1.ListModelsRequest do
  ...
  use Protobuf,
    full_name: "google.ai.generativelanguage.v1.ListModelsRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Ai.Generativelanguage.V1.ListModelsResponse do
  ...
  use Protobuf,
    full_name: "google.ai.generativelanguage.v1.ListModelsResponse",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
