...
defmodule Google.Datastore.V1.Mutation.ConflictResolutionStrategy do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.datastore.v1.Mutation.ConflictResolutionStrategy",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Datastore.V1.PropertyTransform.ServerValue do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.datastore.v1.PropertyTransform.ServerValue",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Datastore.V1.RunAggregationQueryRequest do
  ...
  use Protobuf,
    full_name: "google.datastore.v1.RunAggregationQueryRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Datastore.V1.RunAggregationQueryResponse do
  ...
  use Protobuf,
    full_name: "google.datastore.v1.RunAggregationQueryResponse",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Datastore.V1.PropertyTransform do
  ...
  use Protobuf,
    full_name: "google.datastore.v1.PropertyTransform",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Datastore.V1.PropertyMask do
  ...
  use Protobuf,
    full_name: "google.datastore.v1.PropertyMask",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Datastore.V1.Datastore.Service do
  ...
  use GRPC.Service, name: "google.datastore.v1.Datastore", protoc_gen_elixir_version: "0.17.0"
