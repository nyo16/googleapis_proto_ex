defmodule Google.Datastore.V1.ExplainOptions do
  ...
  use Protobuf,
    full_name: "google.datastore.v1.ExplainOptions",
...
defmodule Google.Datastore.V1.ExplainMetrics do
  ...
  use Protobuf,
    full_name: "google.datastore.v1.ExplainMetrics",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Datastore.V1.PlanSummary do
  ...
  use Protobuf,
    full_name: "google.datastore.v1.PlanSummary",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Datastore.V1.ExecutionStats do
  ...
  use Protobuf,
    full_name: "google.datastore.v1.ExecutionStats",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
