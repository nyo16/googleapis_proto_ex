defmodule Google.Datastore.V1.AggregationResult.AggregatePropertiesEntry do
  ...
  use Protobuf,
    full_name: "google.datastore.v1.AggregationResult.AggregatePropertiesEntry",
    map: true,
...
defmodule Google.Datastore.V1.AggregationResult do
  ...
  use Protobuf,
    full_name: "google.datastore.v1.AggregationResult",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Google.Datastore.V1.AggregationResultBatch do
  ...
  use Protobuf,
    full_name: "google.datastore.v1.AggregationResultBatch",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
